              ...
              <div className="col-xl-12">
                <nav className="navbar navbar-expand-lg navbar-light">
                  <a href="https://townmanor.in/" className="navbar-brand">
                    <img width="250" src="./logo.Townmanorr.png" alt="Townmanor Technologies Pvt Ltd." />
                  </a>
                  ...
                  <div className={`navbar-collapse   ${isMenuOpen ? 'show' : ''}`} id="navbarSupportedContent">
                    <ul className="navbar-nav mr-auto" id="main-menu">
                      ...
                      {/* <li className="nav-item active">
                        <a href="https://townmanor.in/en/197/subscription_plan" className="nav-link active">Find an Agent</a>
                      </li> */}
                    </ul>
